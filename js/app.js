$(function () {
   ...
   var animation = new TimelineMax()
         .fromTo("#socials-wrapper", 10, {opacity: 0}, {opacity: 1, ease: Linear.easeNone})  // fades in
         .fromTo("section.panel.second", 10, {x: "100%"}, {x: "0%", ease: Linear.easeNone})  // in from right
         .fromTo("#resume", 5, {opacity: 1}, {opacity: 0, ease: Linear.easeNone})  // fades out
